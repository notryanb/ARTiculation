This project aims to create an app where Artists can have an outlet to post images that elicit an Artistic response, and gather thoughts and feedback from others regarding these images.
