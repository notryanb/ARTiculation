...
photo1 = Photo.create(url: File.join('http://localhost:9393/img', '1.jpg'), user: kiran)
photo2 = Photo.create(url: File.join('http://localhost:9393/img', '2.jpg'), user: ryan)
photo3 = Photo.create(url: File.join('http://localhost:9393/img', '3.jpg'), user: angel)
photo4 = Photo.create(url: File.join('http://localhost:9393/img', '4.jpg'), user: natalia)
photo5 = Photo.create(url: File.join('http://localhost:9393/img', 'ryan.jpg'), user: ryan)
photo6 = Photo.create(url: File.join('http://localhost:9393/img', 'angel.jpg'), user: angel)
photo7 = Photo.create(url: File.join('http://localhost:9393/img', 'natalia.jpg'), user: natalia)
photo8 = Photo.create(url: File.join('http://localhost:9393/img', 'kiran.jpg'), user: kiran)
photo9 = Photo.create(url: File.join('http://localhost:9393/img', 'lil_peeps.jpg'), user: natalia)
